...
const AuctionSection = () => {
  ...
  // ✅ FIX: use explicit status instead of soldPrice guessing
  const isSold = currentPlayer?.status === "sold";

  return (
    <div className="min-h-screen overflow-hidden text-white grid grid-cols-1 lg:grid-cols-3 gap-3 p-3">

      {/* LEFT PANEL */}
      <div className="lg:col-span-1 flex flex-col backdrop-blur-md bg-white/3 border border-white/10 rounded-2xl overflow-hidden">
        ...
        {/* CONTENT */}
        <div className="flex-1 flex items-center justify-center px-2 py-0 sm:p-2 min-h-0">
      ...
      {/* RIGHT PANEL */}
      <div className="lg:col-span-2 backdrop-blur-md bg-white/3 border border-white/10 rounded-2xl overflow-hidden flex flex-col min-h-0">
